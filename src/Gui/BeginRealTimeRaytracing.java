 ...
 */
public class BeginRealTimeRaytracing extends javax.swing.JFrame {
	...
	public BeginRealTimeRaytracing() {
	...
	private void goButtonMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_goButtonMouseClicked
		...
		if (!error) {
			...
			RenderingWindowRealTime renderWindow = new RenderingWindowRealTime(
					xSize, ySize, cs, activateSuperSampling.isSelected(),
					filename.getText(), color, brdf, begin, end, nbRec, op,
					valueOperator);

...
public class SpherePerlin extends Sphere{
    ...
    IntersectionResult returnIntersectionResult(Point3d intersection,Vector3d  normal,double w){
        ...
        double noise = (1+PerlinImprovedNoise.noise(intersection.x,intersection.y,intersection.z))/2.0;
        ...
        /*
         * double noise = PerlinImprovedNoise.noise(intersection.x,intersection.y,intersection.z);
        double dx = noise/intersection.x;
        double dy = noise/intersection.y;
        double dz = noise/intersection.z;
        Vector3d vect = new Vector3d(dx,dy,dz);

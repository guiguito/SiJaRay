...
public class GeneralCube extends PolygonListObject{
     ...
     * @param origi the center point of the object.
     * @param mat the material of the object.
     * @param sizeX size in the x dimensions.
     * @param sizeY size in the y dimensions.
     * @param sizeZ size in the z dimensions.
     */
    public GeneralCube(Point3d origi,Material mat,double sizeX,double sizeY, double sizeZ){
     ...
     * @param sizeZ size in the z dimensions.
     */
    public GeneralCube(long begin,long end,Point3d origi,Material mat,double sizeX,double sizeY, double sizeZ){
     ...
     * @param sizeZ size in the z dimensions.
     */
    private void initCube(Point3d origi,Material mat,double sizeX,double sizeY, double sizeZ){
        Point3d orig = new Point3d(origi.x-sizeX/2, origi.y-sizeY/2, origi.z-sizeZ/2);
        try{
            ...
            Point3d ptc3 = new Point3d(orig.x+sizeX,orig.y+sizeY,orig.z+sizeZ);
            ...
            Point3d ptd4 = new Point3d(orig.x+sizeX,orig.y+sizeY,orig.z+sizeZ);
            ...
            Point3d ptf3 = new Point3d(orig.x+sizeX,orig.y+sizeY,orig.z+sizeZ);
